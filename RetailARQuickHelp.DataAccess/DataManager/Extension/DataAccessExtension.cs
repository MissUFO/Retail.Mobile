...
using System.Linq;
using RetailARQuickHelp.DataAccess.DataManager.Interface;

namespace RetailARQuickHelp.DataAccess.DataManager.Extension
{
    public static class DataAccessExtension
    {
        ...
        {
            return global::RetailARQuickHelp.DataAccess.DataManager.Extension.DataObjectExtension
                .ToEnum<T>(instance[columnName]);
        }

        public static T ToEnum<T>(this IDataManager instance, string parameterName) where T : struct
        {
            return global::RetailARQuickHelp.DataAccess.DataManager.Extension.DataObjectExtension.ToEnum<T>(
        ...
        {
            return global::RetailARQuickHelp.DataAccess.DataManager.Extension.DataObjectExtension.ToType<T>(
                instance[parameterName].Value);
        }
